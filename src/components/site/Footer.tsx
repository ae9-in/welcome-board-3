...
export function Footer() {
  return (
    <footer id="about" className="relative border-t border-zinc-800 bg-zinc-950 text-zinc-100 overflow-hidden">
      {/* Footer Content */}
      <div className="container mx-auto px-6 pt-20 pb-[240px] md:pb-[320px] relative z-10">
        <div className="flex flex-col gap-12 md:flex-row md:items-end md:justify-between">
          ...
          <nav className="grid grid-cols-2 gap-x-12 gap-y-3 text-sm text-zinc-400">
            <a href="#competitions" className="transition-colors hover:text-white">Competitions</a>
            <Link to="/register" className="transition-colors hover:text-white">Register</Link>
            <a href="#create-event" className="transition-colors hover:text-white">Create Event</a>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[220px] md:h-[300px] pointer-events-none z-0 opacity-25" aria-hidden="true">
        <CrowdCanvas
