...
const LIGHT_HERO_VIDEO = "https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260602_150901_c45b90ec-18d7-42ff-90e2-b95d7109e330.mp4";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Welcome Onboard — Learn, Compete, Shine" },
      { name: "description", content: "Six school competitions across debate, code, art, quiz, performance, and ideation. Pick yours and step on stage." },
