  ...
  return (
    <main className="dark relative min-h-screen bg-background text-foreground">
      <div
        ...
        style={{
          background:
            "radial-gradient(800px 500px at 50% 30%, rgba(255,107,69,0.10), transparent 60%), var(--bg-base)",
        }}
      />
      <div className="flex min-h-screen items-center justify-center px-4">
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <p className="font-mono-meta mt-1 text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
          ...
          <form onSubmit={onSubmit} className="mt-8 space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-md bg-accent px-4 py-3 text-sm font-medium text-accent-foreground transition hover:scale-[1.02] disabled:opacity-60"
            >
              {loading ? "…" : "Sign in"}
            </button>
          </form>
